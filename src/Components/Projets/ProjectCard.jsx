      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 block max-w-7xl mx-auto p-4">
        <div className="flex">
          ...
          <div className="w-1/3 p-6 bg-gray-light">
            ...
            <h2 className="text-xl font-bold text-gray-darker mb-2">
          ...
          <p className="text-gray-darker text-sm mb-2 flex justify-end">Assignees: {assignees || "None"}</p>
            <p className="text-gray-dark">Description:</p>
               <ReactMarkdown>{trucatedDescription}</ReactMarkdown>
            <p className="text-gray-darker text-sm mb-2 mt-auto flex justify-end items-end">Created by: {creator}</p>
          </div>
        </div>
      </div>
  );
