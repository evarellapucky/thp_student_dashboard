  ...
  return(
    <>
      <div className="flex flex-wrap gap-5">
        <h1>Mon profil</h1>
        <div className="flex flex-col md:flex-row justify-center md:justify-start items-center gap-1">
          <img src={moussaillon} alt="corsaire icon" className="w-20 h-20"/>
          <p className={`dialog-box ml-4 animate-text`}>
            Tu peux modifier tes infos perso ici
          </p>
        </div>

      </div>
      <div className="flex flex-col md:flex-row gap-4 my-3 CheckboxGroup">
        <div className="max-w-80 p-5 border-4 bg-gray">
          <div className="border-4 p-1 mb-2">
            <div className="overflow-hidden mask mask-squircle my-2">
          ...
          {!showDropzone && (
            <div className="flex justify-center">
              <DefaultButton name="Modifier mon avatar" onClick={handleButtonClick}>
          ...
          {showDropzone && (
            <div className="flex justify-center mt-2">
              <DefaultButton name="Sauvegarder" color="btn-success" onClick={handleSaveClick}/>
              <DefaultButton name="Annuler" color="btn-error" onClick={handleCancel}/>
            </div>
          )}

        </div>
        <div className="">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-5 m-1 border-4 border-amber-700">
            <div className="border-b-4 border-amber-700">
              <h4>Prénom</h4>
          ...
          <div className="flex flex-row flex-nowrap justify-around border-b-4 border-amber-700">
            <a href={`${extractLink(profileData.github)}`} className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="w-16 h-16">
            ...
            <a href={`${extractLink(profileData.linkedin)}`} className="flex items-center">
      ...
      <div className="flex flex-wrap gap-3 px-4 justify-center sm:justify-start">
        <DefaultButton name="Modifier mon profil" onClick={handleOpenEditProfileModal}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
          </svg>
        </DefaultButton>

        <DefaultButton name="Modifier mon mot de passe" onClick={handleOpenEditPasswordModal}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 0 1 3 3m3 0a6 6 0 0 1-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1 1 21.75 8.25Z" />
          </svg>
        </DefaultButton>

        <DefaultButton name="Supprimer mon profil" color="btn-error">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
