...
import bateau from "../../Assets/bateau_animaux.jpg"
  ...
  return(
    <>
      <div className="flex flex-wrap gap-5">
        <h1>Mon profil</h1>
        <div className="flex">
          <img src={moussaillon} alt="corsaire icon" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 CheckboxGroup">
        <div className="col-span-1 md:col-span-2 order-last md:order-first">
          {/* <div className="w-full h-64">
            <img src={bateau} alt="bateau animaux" className="w-full h-full object-cover"/>
          </div> */}
