  ...
  return(
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 CheckboxGroup">
        <div className="col-span-1 md:col-span-2 order-last md:order-first">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-5 m-1">
            <div>
              <h4>Prénom</h4>
        ...
        <div className="max-w-80 p-5 border-4">
          <div className="w-full overflow-hidden mask mask-squircle my-2">
