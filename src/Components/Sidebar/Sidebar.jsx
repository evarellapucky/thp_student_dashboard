...
const Sidebar = () => {
  ...
  const [isSidebarMinimized, setIsSidebarMinimized] = useState(true); // Nouvel état pour la Sidebar réduite
            ...
            >
              <summary
                className={`text-white flex items-center ${
                  !isSidebarMinimized && !isOpenSearch
                    ? "hover:bg-blue-700"
              ...
              >
                ...
                <img
                  src={toggler_logo}
                  alt="toggle"
                  className={`w-4 h-4 ${isSidebarMinimized ? "hidden" : ""}`}
                />
              </summary>
          ...
          <SidebarItem
            ...
            icon={
              <img
                src={disconnect}
                alt="disconnect"
                className={`w-6 h-6 ${isSidebarMinimized ? "mx-auto" : "mr-2"} hover:scale-110 transition-transform duration-200`}
              />
            }
