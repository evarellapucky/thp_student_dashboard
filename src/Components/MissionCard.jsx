...
const MissionCard = ({ number, update, title, assignees, assigneesCount, description, html_url, creator, state, labels, labelColors, commentsCount }) => {
  ...
  const trucatedDescription = truncateText(description || "No descreiption", 100);
