...
const Today = () => {
  ...
  // Déterminer le mode de countdown en fonction de dayState
  ...
  // Log pour vérifier le mode de countdown
  console.log('Countdown Mode:', countdownMode);

  // Fonction appelée lorsque le compte à rebours se termine
  ...
  return (
    <>
      {/* Afficher Countdown seulement si dayState est 'withSubmission' ou 'correction' */}
      ...
      {dayState === 'correction' && isCountdownActive && (
        <div>
